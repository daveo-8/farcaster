...
export default function RaceDetailPage({ params }: { params: { id: string } }) {
    ...
    const potentialWin =
        selectedHorseData && betAmount ? (Number.parseFloat(betAmount) * selectedHorseData.odds).toFixed(0) : "0"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className="pr-16"
                                />
                                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-muted-foreground">coins</div>
                            </div>
